package com.aang23.rsinfinitewireless.block;
...
public class BlockInfiniteWirelessTransmitter extends BlockNode {
    // From BlockTorch
    private static final AxisAlignedBB INFINITE_WIRELESS_TRANSMITTER_AABB = new AxisAlignedBB(0.4000000059604645D, 0.0D,
            0.4000000059604645D, 0.6000000238418579D, 0.6000000238418579D, 0.6000000238418579D);

    public BlockInfiniteWirelessTransmitter() {
        super(BlockInfoBuilder.forMod(RSInfiniteWireless.INSTANCE, RSInfiniteWireless.ID, "infinite_wireless_transmitter")
                .tileEntity(TileInfiniteWirelessTransmitter::new).create());
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
        ...
        return openNetworkGui(RSInfiniteWirelessGui.INFINITE_WIRELESS_TRANSMITTER, player, world, pos, side);
    }
